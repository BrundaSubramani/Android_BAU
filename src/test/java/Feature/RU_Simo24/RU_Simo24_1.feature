Feature: Feature001
  Scenario Outline: To verify sales rep is able to perform E2E
    ...
    Examples:
      |Scenario_Id         | MPN       | CompanyName | account pin |select handset                      |IMEI Number    |Select Tariff                 |
      |BSBC-1343 BSBC-1338 |07805203200|testaccount   |1010        |   Apple iPhone SIM - Smartphone    |100000000000000| Small Biz SIMO 6GB 24M SRU Opt 1|